...
public class Class {
    ...
    public Class(int classID, int year, char block, String yearBlock) {
    ...
    public Class(int ccl_ID, int classID, String yearBlock) {
        this.ccl_ID = ccl_ID;
        this.classID = classID;
        this.yearBlock = yearBlock;
    }

    public Class(int classID, String yearBlock) {
        this.classID = classID;
        this.yearBlock = yearBlock;
    }
